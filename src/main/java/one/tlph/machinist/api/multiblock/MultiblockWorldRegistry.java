...
final class MultiblockWorldRegistry {
    ...
    public MultiblockWorldRegistry(final IWorld world) {
        worldObj = world;
    ...
    protected IMultiblockPart getMultiblockPartFromWorld(final IWorld world, final BlockPos position) {
