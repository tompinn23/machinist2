...
//            TileEntityType.Builder.create(BlastFurnaceControllerTileEntity::new, ModBlocks.blastController).build(null));
    ...
    public static final TileEntityType<SmelterTileEntity> SMELTER = null;

	public static final TileEntityType<CrusherTileEntity> CRUSHER = null;
	public static final TileEntityType<BlastFurnaceCasingTileEntity> BLAST_FURNACE_CASING = null;
	
	public static final TileEntityType<BlastFurnaceControllerTileEntity> BLAST_FURNACE_CONTROLLER = null;
