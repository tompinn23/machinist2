...
public interface IMultiblockRegistry {
     ...
     */
    void onPartAdded(IWorld world, IMultiblockPart part);
     ...
     */
    void onPartRemovedFromWorld(IWorld world, IMultiblockPart part);
     ...
     */
    void addDeadController(IWorld world, MultiblockControllerBase controller);
     ...
     */
    void addDirtyController(IWorld world, MultiblockControllerBase controller);
}
